...
const ProductCardList = () => {
  ...
  const foundProducts = sortedProducts.filter((product) =>
    product.name.toLowerCase().trim().includes(searchString)
  );
  ...
  const {
    ...
    contentOnObjectPage: 6,
    numberOfPages: foundProducts.length,
  });
